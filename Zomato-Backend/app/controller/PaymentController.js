...
var instance = new Razorpay({
  key_id: "rzp_test_yrU0xWTYzOFZsH",
  key_secret: "kV6ydn1sm7oT2ld4XtxnAKfx",
});
...
module.exports.callback = async (request, response) => {
  ...
  var expectedSignature = crypto.createHmac("sha256", process.env.KEY_SECRET).update(bodyText.toString()).digest("hex");
